...
middlePrev = int(len(multiples_of_threes)/2-1) # ambil nilai di tengah list, kurangi satu
middleNext = int(len(multiples_of_threes)/2+2) # ambil nilai di tengah list, di tambah satu, agar list berhenti menghitung satu angka didepan tengah list

print(middlePrev, middleNext)
print(f'The first three items in the list are: {multiples_of_threes[:3]}')
print(f'Three items from the middle of the list are: {multiples_of_threes[middlePrev:middleNext]}')
